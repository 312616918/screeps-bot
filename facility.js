...
/**
 * @typedef {Object} RoomPos
 * @property {RoomPosition[]} sources
 * @property {RoomPosition} [mineral]
 * @property {RoomPosition} [dispatch]
 * @property {RoomPosition} [upgrade]
 */


/**
 * @type Object.<string,RoomPos>
 */
let workPos = {
